...
namespace Gato_Exploso
{
    public class Hud
    {
        ...
        {
            spriteBatch.Draw(texture, new Rectangle(1100, GraphicsAdapter.DefaultAdapter.CurrentDisplayMode.Height - 300, 408, 128), Color.Gray);
            spriteBatch.Draw(texture, new Rectangle(1104, GraphicsAdapter.DefaultAdapter.CurrentDisplayMode.Height - 296, health * 4, 120), Color.Lime);
